...
public class Sem3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Sem 3 Subjects");
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Sem3Activity.this,"Student Data has been inserted",Toast.LENGTH_SHORT).show();
                addStudents();
    ...
    public void addStudents(){
        ...
        DatabaseReference current_user_db = FirebaseDatabase.getInstance().getReference().child("Sem3").child(user_id).push();
        ...
        if(cc >50 ) {
            ...
            Toast.makeText(Sem3Activity.this, "Coursework must not over 50%!", Toast.LENGTH_LONG).show();
        }
        else if (ex >50){
            Toast.makeText(Sem3Activity.this, "Exam mark must not over 50%!", Toast.LENGTH_LONG).show();
        }
            ...
            Intent inToMain = new Intent(Sem3Activity.this,Sem3Retrieved.class);
